                ...
                <div class="row">
                       ...
                       <!-- Block  Breadcrumb-->
                        ...
                        <div id="layered-filter-block" class="block-sidebar block-filter no-hide">
                            ...
                            <div class="block-content">
                                ...
                                $types = array();
                                if(isset($url_params['filters']['f']) && !empty($url_params['filters']['f'])){
                                    $types = explode(',', $url_params['filters']['f']);
                                }
                                  ?>
                    ...
                    <div class="col-lg-9 col-md-9  col-main">
                        ...
                        <div class=" toolbar-books toolbar-top">
                            ...
                            $max_view_links = $pagination['max_view_links'];
                            $num_links = $pagination['num_links'];
                            ?>
                            <div class="marg-top-5">
                                <span>Total results : <?php echo $pagination['total_rows'];?></span>
                            </div>
                            <?php if($num_links>0){ ?>
                            ...
                            <ul class="pagination">
                              <?php if($current_page>1){ ?>                             
                               ...
                               <a href="?<?php echo $url_params['extra_params_to_link']; ?>&page=<?php echo $current_page-1; ?>">
                                ...
                                <?php
                                $gg = $current_page;
                                if($current_page>=1 && $current_page<5) $gg = 4;
                                elseif($current_page>=$num_links-3) $gg = $num_links-3;
                                if($max_view_links > $num_links) $links = range(1,$num_links);
                                else $links = array(1,2,$gg-1,$gg,$gg+1,$num_links-1,$num_links);
                              foreach ($links as  $curr) {
                                ?>
                                <li class="action">

                                <a href="?<?php echo $url_params['extra_params_to_link']; ?>&page=<?php echo $curr; ?>" class="<?php echo ($curr==$current_page) ? 'active' : '';?>"><?php echo $curr; ?></a>
                                </li>
                                <?php 
                                }
                                ?>
 
                              <?php if($current_page<$num_links){ ?>                             
                               <li class="action">
