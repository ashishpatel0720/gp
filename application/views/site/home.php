        ...
        <div class="site-main">
                               ...
                               <div class="block-content">
                                ...
                                <?php foreach ($categories as $key => $main) {
                                 ?>
                                    <li class="parent">
                                        <a href="#">
                                            <span class="icon"><img src="/static/site/images/icon/index1/nav-cat1.png" alt="nav-cat"></span>
                                            <?php echo $key;?>
                                        </a>
                                        <span class="toggle-submenu"></span>
                                        <div class="submenu" style="background-image: url(/static/site/images/media/index1/bgmenu.jpg);">
            ...
            <!--service  -->
        <!--     <div class="block-service-opt8">
                <div class=" container">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="item">
                                <div class="icon">
                                    <img src="/static/site/images/media/index8/service1.png" alt="service">
                                </div>
                                <div class="detail">
                                    <div class="title">
                                        Buyer Protection
                                    ...
                                    <div class="des">
                                        Secure payments
                                        <br>Guaranteed refunds
                                        <br>Escrow protection on every oder
                                    </div>
                        ...
                        <div class="col-sm-4">
                            <div class="item">
                                <div class="icon">
                                    <img src="/static/site/images/media/index8/service2.png" alt="service">
                                </div>
                                <div class="detail">
                                    <div class="title">
                                        RETURN & EXCHANGE
                                    ...
                                    <div class="des">
                                        Wholesale books from certified sellers
                                        <br>Worldwide shipping
                                        <br>Low prices from US $0.1
                                    </div>
                                    <a href="#" class="btn">Read more <i aria-hidden="true" class="fa fa-angle-double-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="item">
                                <div class="icon">
                                    <img src="/static/site/images/media/index8/service3.png" alt="service">
                                </div>
                                <div class="detail">
                                    <div class="title">
                                        FREE DELIVERY
