<style media="screen">
    ...
    .add-portfolio,.portfolio-block,.portfolio-stat,.portfolio-text,.portfolio-text .portfolio-text-info {
        overflow: hidden
    }
    ...
    .profile-settings .controls>.checkbox,.profile-settings .controls>.radio {
        font-size: 12px;
...
// } );
        ...
        var t;
        t = $('.scroller').attr("data-height") ? $('.scroller').attr("data-height") : $('.scroller').css("height");
        console.log(t);
        $('.scroller').slimScroll({
            allowPageScroll: !0,
            size: "7px",
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="profile">
                ...
                <div class="row">
                    <div class="col-md-3 col-lg-3 col-sm-3"style="margin-left:0em; ">
                        <div class="profile-sidebar">
                            ...
                            <div>
                                <div class="margin-top-20 profile-desc-link">
                                    <i class="fa fa-globe"></i><?php if($user_data) echo '<a href="http://'.$user_data['user_website'].'">'.$user_data['user_website'].'</a>';
                                    else echo "<a href='/user/account_settings'>Add Now</a>"?>
                                    </a>
                                </div>

                                <div class="margin-top-20 profile-desc-link">
                                    <i class="fa fa-twitter"></i><?php if($user_data['user_twitter_id']) echo '<a href="https://twitter.com/'.$user_data['user_twitter_id'].'">'.$user_data['user_twitter_id'].'</a>';
                                    else echo "<a href='/user/account_settings'>Add Now</a>"?>
                                    </a>
                                </div>
                                <div class="margin-top-20 profile-desc-link">
                                    ...
                                    <?php
                                    if($user_data['user_facebook_id']) echo '<a href="https://facebook.com/'.$user_data['user_facebook_id'].'">'.$user_data['user_facebook_id'].'</a>';
                                    else echo "<a href='/user/account_settings'>Add Now</a>"
                                    ?>
                    ...
                    <div class="col-md-6 col-lg-6 profile-content" style="margin-left:0em;margin-right:1em;">
                        ...
                        <div class="tabbable-line tabbable-custom-profile">
                            <ul class="nav nav-tabs">
                                <!-- <li class="active">
                                    <a href="#tab_1_11" data-toggle="tab"> Latest  </a>
                                </li> -->
                                <li class="active">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc"> You have 4 new assignment submissions.
                                                    ...
                                                    <a href="javascript:;">
                                                        <div class="col1">
                                                            <div class="cont">
                                                                ...
                                                                <div class="cont-col2">
                                                                    <div class="desc"> 1 new Follower ! </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc">12 new books in Thermodynamics. </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc"> Trending subjects !!! </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc"> New question by a student, Please help him. </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc"> New student enrolled. </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
                    ...
                    <div class="col-md-2.8 col-md-2.8 col-sm-2.8 profile-content">
                        <div class="row">
                            <div class="col-md-12 profile-info">
                                <h1 class="sbold uppercase">Suggested Course</h1>
