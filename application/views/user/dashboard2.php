          ...
          <div class="col-md-4 col-lg-4 col-sm-4">
            <div class="profile-sidebar">
              ...
              <div>
                ...
                <div class="margin-top-20 profile-desc-link">
                  <i class="fa fa-twitter"></i><?php if($user_data) echo '<a href="https://twitter.com/'.$user_data['user_twitter_id'].'">'.$user_data['user_twitter_id'].'</a>';
                    else echo "<a href='/user/account_settings'>Add Now</a>"?>
                  </a>
                </div>
                <div class="margin-top-20 profile-desc-link">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            <thead>
                                <tr>
                                    <th>
                                        <i class="fa fa-briefcase"></i> dd1 </th>
                                    <th class="hidden-xs">
                                        <i class="fa fa-question"></i> dd2 </th>
                                    <th>
                                        <i class="fa fa-bookmark"></i> dd3 </th>
                                    <th> </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="javascript:;"> ppop </a>
                                    </td>
                                    <td class="hidden-xs"> ppop </td>
                                    <td> ppop
