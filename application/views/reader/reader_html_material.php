...
<?php
$path = '/static/book_html/'.$material['folder_path'];
?>
<link rel="stylesheet" type="text/css" href="<?php echo $path ?>/base.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo $path ?>/fancy.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo $path.'/'.$material['folder_path']; ?>.css">
...
<div class="modal_ fade in" id="book_read_modal_" style="padding:0;">
    <div class="modal_-dialog">
        ...
        <div class="modal_-header">
                ...
                <a href="/courses/view/<?php echo $material['material_id'].'/'.$material['material_alias']; ?>" class="pull-left"><i class="glyphicon glyphicon-menu-left"></i> <span class="hidden-xs">Back </span></a>

                <span class="text-center"><?php echo substr($material['material_title'],0,300); ?></span>
...
$(function() {
  ...
  load_page = function(page_id,this_){
      ...
      $.ajax({
      url: '/reader_html/<?php echo $material['folder_path']; ?>/content/page_html/'+(page_id),
      type: 'POST',
